...
MODEL_PATH="/input2/yzw/models/DeepSeek-R1-Distill-Qwen-1.5B"
...
PROJECT_NAME="ARLCP"
EXP_NAME="ARLCP-DeepSeek-R1-Distill-Qwen-1.5B-eval"
...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.total_epochs=3 $@ 2>&1 | tee ./log/ARLCP-1.5B_eval.log